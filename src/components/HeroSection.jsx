  ...
  return (
    <div className="heroContainer container  mx-auto px-4  ">
      <div className=" flex flex-col-reverse md:flex-row md:gap-10 lg:gap-20  md:justify-between  ">
        <div className=" flex flex-col mainText md:pl-16 md:w-[50%] text-center justify-center items-center md:text-left  pb-5  ">
          <h1 className=" font-extrabold text-3xl mb-1  text-neutral-very-dark-violet md:text-3xl lg:text-6xl leading-7">
        ...
        <div className="heroImage md:w-[50%] ">
